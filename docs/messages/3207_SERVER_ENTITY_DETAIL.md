...
| Handler(s) | `0x00872FA0` |

### Fields

| # | Name | Type | Size | Read Address |
|---|------|------|------|-------------|
| 1 | `byResult` | `u8` | 1 | `0x00873011` |
| 2 | `byField_02` | `u8` | 1 | `0x0087301F` |
| 3 | `wField_03` | `u16` | 2 | `0x00873034` |
| 4 | `byField_04` | `u8` | 1 | `0x00873089` |
...
```
  ...
  [  30] ullField_13                    u64
  [  38] dwField_14                     u32
  [  42] bytesData_14                   bytes  (variable length)
  [   0] ullField_16                    u64
  [   8] dwField_17                     u32
  [  12] byField_18                     u8
  [  13] ullField_19                    u64
