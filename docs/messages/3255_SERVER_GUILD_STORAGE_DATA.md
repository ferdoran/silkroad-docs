...
> Previously documented as `SERVER_ACADEMY_DATA_2` (client-derived).
...
=== "C#"
    ```csharp
    // C#
    public record GuildStorageData(
        byte Slot,
        uint RentableType,
        uint RefItemID,
        ushort Quantity,
