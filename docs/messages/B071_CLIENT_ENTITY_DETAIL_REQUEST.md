...
| 2 | `wField_02` | `u16` | 2 | `0x008A6020` |
| 3 | `bytesData_2` | `bytes` | variable | `0x008A6052` |
| 4 | `dwField_04` | `u32` | 4 | `0x008A6060` |
| 5 | `dwField_05` | `u32` | 4 | `0x008A606E` |
| 6 | `dwField_06` | `u32` | 4 | `0x008A607C` |
...
```
  [   0] byResult                       u8
  [   1] wField_02                      u16
  [   3] bytesData_2                    bytes  (variable length)
  [   0] dwField_04                     u32
  [   4] dwField_05                     u32
  [   8] dwField_06                     u32
  [  12] dwField_07                     u32
